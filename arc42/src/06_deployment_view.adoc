...
The PSD2 Accelerator consists of 10 deployments, united into one docker-compose file. The _sandbox_ itself provides the XS2A API and a 3 web applications (and its API): developer portal, online banking and TPP UI.
