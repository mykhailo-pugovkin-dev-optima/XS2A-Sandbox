...
implemented as an Angular app and bundled at build time in the backend JAR. The XS2A Sandbox consists of the _sandbox_ and the _ssl-proxy_.
...
XS2A Sandbox depends on XS2A Interface (consent-management, aspsp-profile, xs2a interface inself) and Ledgers.
